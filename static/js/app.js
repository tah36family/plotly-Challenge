...
function updatePlots(index) {
 ...
 // cut and reverse data for horizontal bar chart
 ...
 // lets take a look at the Gauge chart
 ...
 var trace3 = [{
  ...
  function refreshData() {
    ...
    // give the value of the dropdown menu option to a variable
    var personsID = dropdownMenu.property("value");
    console.log(personsID);
    // begin  an empty array for the person's data
    console.log(data)
